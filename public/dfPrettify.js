/*
* dfPrettify - jQuery plugin to pretty-print or minify text in XML, JSON, CSS and SQL dfPrettifys.
* https://github.com/zachofalltrades/jquery.dfPrettify
*
* Version - 0.1
...
(function( $ ) {
	...
	var Formatter = function (options) {
		...
		this.dfPrettify = function(text) { //alias to currently selected method
	...
	Formatter.prototype = {
		...
		init: function(options) {
			this.options = $.extend({}, $.fn.dfPrettify.defaults, options);
	 ...
	 */
	$.fn.dfPrettify = function(options) {
...
//			console.log("text ==>\n" + text);
	 ...
	 * utility version
	 */
	$.dfPrettify = function(text, options) {
		var fmt = new Formatter(options);
//		var methodName = fmt.options.method;
//		if (!$.isFunction(fmt[methodName])) {
//			$.error("'" + methodName + "' is not a Formatter method.")
...
//		return fmt[methodName].call(fmt, text);
		return fmt.dfPrettify(text);
	};

	/**
	 * default configuration
	 */
	$.fn.dfPrettify.defaults = {
